...
| 5: Kharad | 5 | 84/256 (32.81%) | Complete 2,918-party staged confirmation Pass; linked Health 3.04881408 / Power 3.85370128 applied locally with exact report parity. Adjusted strongest-team interval 22.63–44.91%; search quality remains Fail. |

The later [v4 pilot](Tower-Party-Coverage-Review.md) measured two newly generated Kharad builds at **89/256 (34.77%)** and **99/256 (38.67%)** under the same applied boss setting. These are separate 16-cell pilot results; the 2,918-party confirmation above retains its original scope. Later v6/v7/v8 control measurements include observed ceiling breaches, recorded separately in the [current handoff](Tower-Coverage-Replication-Plan.md#completed-studies); the historical Pass does not establish current expanded-family acceptance. Both builds came from one restart, so search reliability remains **Fail (1/3; 2 required)**. Both were carried into the [separate replication](Tower-Coverage-Replication-Review.md) as reference controls and won **82/256 and 112/256**. All 12 new generated finalists won zero; reliability is **Fail (0/3)** and the 18-cell assessment is **Inconclusive**. The next floor batch remains deferred.

These cohorts use the full 80-Essence pool with hypothetical ownership. Four slots through floor 4 is an explicit working interpolation. The deferred progression batch targets floors 6–9 at five slots, floor 10 at six and floor 11 with at least seven, with separate lower-budget diagnostics; independent reliability takes priority under the [current handoff](Tower-Coverage-Replication-Plan.md). The [history-capacity prerequisite](Automatic-Tower-Team-Discovery-Plan.md#next-batch-history-capacity-and-floors-611) is complete: cumulative history now supports 1,000,000 exclusions. Remaining progression studies are pending, with competitive search validation taking priority. Preserve every exclusion and keep combat caps separate.
