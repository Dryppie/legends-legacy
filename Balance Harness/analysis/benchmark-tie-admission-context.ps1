...
try {
    ...
    if ($Mode -eq 'bind') {
        ...
        $plan = [BalanceHarness.TowerProposalComparison]::CreateSelectorPlan($context, $old.Candidate)
        Put 'plan.json' $plan
    ...
    if ($Mode -eq 'candidate') {
        ...
        foreach ($name in @('TowerAffinityCreation','TowerAdaptiveRacingGenerator','TowerBatchRacing','TowerProposalStudy','TowerProposalPolicies','TowerProposalComparison','TowerProposalRacingNative',
