...
spec = importlib.util.spec_from_file_location('allied_action_publication',Path(__file__).with_name('verify-affinity-allied-action-publication.py'))
...
class PublicationTests(unittest.TestCase):
    ...
    def test_old_study_version_or_old_allocation_cannot_be_verified_as_allied_action(self):
...
class AccountingTests(unittest.TestCase):
    def setUp(self):
        self.prior = dict(status='VerifiedAlliedActionAdmissionNoReservation',cumulativeRecordedSeconds=21000,
...
class ExecutionTests(unittest.TestCase):
    def setUp(self):
        ...
        self.prior=dict(status='VerifiedAlliedActionAdmissionNoReservation',cumulativeRecordedSeconds=21000,
            cumulativeRecordedBytes=17000000000,cumulativeDeclaredMaximumSeconds=30000,cumulativeDeclaredMaximumBytes=21000000000)
        self.d=dict(version='tower-affinity-allied-action-execution-v1',studyVersion=a.VERSION,scientificLaunches=1,retries=0,
