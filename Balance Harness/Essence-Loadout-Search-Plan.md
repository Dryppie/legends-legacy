...
**Current priority, updated 12 September 2026:** historical-seed capacity is extended, and the [competitive Kharad campaign](Tower-Competitive-Build-Search-Review.md) completed a scoped portfolio balance Pass while search quality remains Fail. Complete the [bulk-performance prerequisite](Automatic-Tower-Team-Discovery-Plan.md#immediate-next-increment-bulk-performance) before more large searches: bounded profiling, compact archives, reusable immutable preparation and resumable verification, followed by parity and measured throughput/storage gains. The [workload review](Tower-Competitive-Workload-Performance-Review.md) explains the cost and sequencing problems. Then improve combination-search reliability at current boss settings and continue the [floors 6–11 checklist](Automatic-Tower-Team-Discovery-Plan.md#next-batch-history-capacity-and-floors-611): five Essences on floors 6–9, six on floor 10 and seven on floor 11. Keep the current gear/untrained-Essence budget and unchanged [10–50% policy](Tower-Balance-Acceptance-Policy.md); preserve high-clear candidates, fresh seeds and separate lower-budget diagnostics. Practical ownership and equipment acquisition remain unverified. The [bounded profiling command](Tower-Performance-Benchmark-Review.md) and [opt-in compact archives](Tower-Compact-Archive-Review.md) are implemented. The latter preserved exact results/replays with 88.69% smaller ordinary archives and 10.31–15.17% lower overall runtime on a fixed 1,200-combat comparison. Next implement preparation reuse and unused checkpoint removal, then bounded/resumable verification and campaign integration; search drivers still emit their existing archives.
