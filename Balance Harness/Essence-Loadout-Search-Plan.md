...
**Current priority, updated 11 September 2026:** floors 1–5 now have scoped passing evidence under the declared full-pool assumptions; see the [current progression review](Tower-Progression-Floors-2-to-5-Review.md). Extend bounded historical-seed capacity, then independently audit floors 6–9 with five Essences per character, floor 10 with six and floor 11 with seven. The [next-batch checklist](Automatic-Tower-Team-Discovery-Plan.md#next-batch-history-capacity-and-floors-611) keeps existing exclusions, combat caps and fresh confirmation intact. Apply the unchanged [10–50% Tower policy](Tower-Balance-Acceptance-Policy.md): no evaluated intended-budget build above 50%, at least one supported at 10%, and explicit uncertainty. Preserve high-clear candidates for calibration and keep lower-budget diagnostics separate. Practical ownership and equipment acquisition remain unverified.
