...
The user has now selected Goblin Warrior, Sword and Heavy Chest for Blood Grove and approved a 70% clear-rate aim with a 65–75% initial working band. The [selected starter reference](Blood-Grove-Starter-Reference.md) records the exact level-5 recipe, its separate 400-battle initial measurement and the subsequent scoped policy evaluation. Next is a focused tuning experiment toward that band with the recipe fixed.
