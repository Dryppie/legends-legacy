...
- [x] **The Soul Archive** — absorb the chosen First Hunt Essence, then attune it in the active Essence loadout.
- [x] **Forge Your Path** — craft a Tier 1 one-handed weapon, then equip that crafted weapon.
- [x] **Tools of the Trade** — equip one gathering tool.
- [x] **Into the Ruins** — win one encounter in Lumo Ruins.

### Shenic Campaign

- [x] **Trial of Lumo** — win 10 encounters in Lumo Ruins.
- [x] **Blood in the Grove** — win 5 encounters in Blood Grove.
- [x] **Crystal Currents** — win 7 encounters in Crystal Creek.
- [x] **The Restless Dead** — win 8 encounters in Moonlit Graves.
- [x] **Between Day and Night** — win 10 encounters in Twilight Clearing.
- [x] **The Roots Remember** — win 10 encounters in Old Forest.
- [x] **Heart of the Hollow** — win 12 encounters in Thornroot Hollow.
- [x] **Ash Beneath the Earth** — win 12 encounters in Embercap Burrows.
- [x] **The Veil Over the Marsh** — win 15 encounters in Moonveil Marsh.
...
- [ ] **Repeatable bounties** — complete a rotating area, gathering, dungeon, Colosseum, or Prophecy objective before its reset.
