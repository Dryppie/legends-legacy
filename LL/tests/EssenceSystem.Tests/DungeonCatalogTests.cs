...
public sealed class DungeonCatalogTests
{
    ...
    public void CurrentCatalog_MaterializesExpectedDefinitions()
    {
        ...
        var expected = new[]
        {
            ...
            new ExpectedDungeon("forgotten_catacombs", "Forgotten Catacombs I", DungeonGrade.GradeI, 11, 13, 1, null, 3.9f),
            new ExpectedDungeon("forgotten_catacombs_ii", "Forgotten Catacombs II", DungeonGrade.GradeII, 12, 14, 1, "forgotten_catacombs", 6.4f),
            new ExpectedDungeon("forgotten_catacombs_iii", "Forgotten Catacombs III", DungeonGrade.GradeIII, 13, 15, 1, "forgotten_catacombs_ii", 9.5f)
        };
