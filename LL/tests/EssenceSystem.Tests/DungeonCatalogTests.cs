...
public sealed class DungeonCatalogTests
{
    ...
    public void CurrentCatalog_MaterializesExpectedDefinitions()
    {
        ...
        var expected = new[]
        {
            new ExpectedDungeon("goblin_mines", "Goblin Mines I", DungeonGrade.GradeI, 250, 10, 12, null),
            new ExpectedDungeon("goblin_mines_ii", "Goblin Mines II", DungeonGrade.GradeII, 750, 11, 13, "goblin_mines"),
            new ExpectedDungeon("goblin_mines_iii", "Goblin Mines III", DungeonGrade.GradeIII, 2000, 12, 14, "goblin_mines_ii"),
            new ExpectedDungeon("forgotten_catacombs", "Forgotten Catacombs I", DungeonGrade.GradeI, 400, 11, 13, null),
            new ExpectedDungeon("forgotten_catacombs_ii", "Forgotten Catacombs II", DungeonGrade.GradeII, 1150, 12, 14, "forgotten_catacombs"),
            new ExpectedDungeon("forgotten_catacombs_iii", "Forgotten Catacombs III", DungeonGrade.GradeIII, 3000, 13, 15, "forgotten_catacombs_ii"),
            new ExpectedDungeon("hives_abyss", "The Hive's Abyss I", DungeonGrade.GradeI, 650, 12, 14, null),
            new ExpectedDungeon("hives_abyss_ii", "The Hive's Abyss II", DungeonGrade.GradeII, 1800, 13, 15, "hives_abyss"),
            new ExpectedDungeon("hives_abyss_iii", "The Hive's Abyss III", DungeonGrade.GradeIII, 4800, 14, 16, "hives_abyss_ii")
        };
