...
public sealed class DungeonMasteryBenefitsTests
{
    ...
    [InlineData(3, 1, 2, 0, 0)]
    [InlineData(4, 1, 2, 1, 0)]
    [InlineData(5, 1, 2, 1, 10)]
    [InlineData(6, 2, 2, 1, 10)]
    [InlineData(7, 2, 4, 1, 10)]
    [InlineData(8, 2, 4, 1, 10)]
    [InlineData(9, 2, 4, 2, 10)]
    [InlineData(10, 2, 4, 2, 10)]
