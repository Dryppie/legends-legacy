...
public sealed class CharacterActionFlowTests
{
    ...
    private sealed class CraftingServiceStub : ICraftingService
    {
        ...
        public Task<Response<LearnBlueprintResult>> LearnBlueprintAsync(Guid characterId, Guid blueprintItemInstanceId, CancellationToken cancellationToken) => throw new NotSupportedException();
