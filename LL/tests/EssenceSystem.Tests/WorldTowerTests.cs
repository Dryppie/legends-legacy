...
public sealed class WorldTowerTests
{
    ...
    public void CatalogReleasesFifteenContiguousFloorsUsingExistingCreatures()
    {
        ...
        Assert.Equal(233, floors[10].RecommendedPowerRating);
        ...
        Assert.Equal(241, floors[11].RecommendedPowerRating);
        ...
        Assert.Equal(251, floors[12].RecommendedPowerRating);
        ...
        Assert.Equal(260, floors[13].RecommendedPowerRating);
        ...
        Assert.Equal(269, floors[14].RecommendedPowerRating);
