...
public sealed class EssenceCatalogServiceTests
{
    ...
    public async Task Catalog_includes_Meran_essences_with_item_and_ability_metadata()
    {
        ...
        Assert.Equal(
            ["Warfang Frontier", "Rotgrave Fields", "Tempest Aerie", "Wolfsbane Reach", "Sunken Scalehold", "Tangled Cave", "The Great Tree", "Sanguine Horror"],
        ...
        var essences = meran.Areas
            ...
            .ToList();
        Assert.Equal(32, essences.Count);
