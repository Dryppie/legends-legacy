...
public sealed class RealtimeWorldTowerGameEventOutboxConsumerTests
{
    [Fact]
    public async Task PublishesCommittedRallyStateToTheWorldAudience()
    {
        ...
        var consumer = new RealtimeWorldTowerGameEventOutboxConsumer(realtime, options);
        ...
        var published = Assert.IsType<WorldTowerRallyUpdated>(realtime.Message);
