...
**Selection tie audit complete — 17 September 2026:** The [saved-evidence review](../../../Balance%20Harness/Tower-Practical-Selection-Tie-Review.md) reconstructed all 12 comparison outputs and the earlier diagnostic primary. Three comparison outputs had top selection ties; retaining the designated primary would change two, with observed holdout gains of 7.9 and 2.8 points. This retrospective hypothesis is not validated for future searches. Next: implement an optional versioned primary-retaining tie rule and archive verification. Nine analyzer tests passed; zero new fights or values. Defaults and both closed comparison decisions remain unchanged.
...
**Historical notices:** the earlier run summaries below retain their original panels, reservation totals and Hold decisions. Use the completed fixed-team result above for the current recommendation and exclusion total.
