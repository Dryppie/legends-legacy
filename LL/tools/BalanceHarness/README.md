...
Current local previews include **4 / 50 / 52 / 50 / 8 compatible saved controls for floors 1–5**, respectively. They enter fresh confirmation; independent generation starts from scratch. These additional records live in the configured results folder, with supporting archives, rather than the unchanged portable fixture. Current previews exclude **97,838 historical seeds**. The [next-batch checklist](../../../Balance%20Harness/Automatic-Tower-Team-Discovery-Plan.md#next-batch-history-capacity-and-floors-611) requires a bounded history-capacity extension before floors 6–9 at five Essences, floor 10 at six and floor 11 at seven; that extension and those studies are pending.
