...
public sealed record CombatAcquisitionRewardOutcome(IReadOnlyList<InventoryItem> Equipment, IReadOnlyList<InventoryItem> Scrap,
    IReadOnlyList<InventoryItem> Sigils)
{
