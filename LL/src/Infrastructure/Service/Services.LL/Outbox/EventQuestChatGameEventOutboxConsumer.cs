...
public sealed class EventQuestChatGameEventOutboxConsumer(
    ...
    JsonSerializerOptions jsonOptions) : IGameEventOutboxConsumer
{
    ...
    public string Consumer => GameEventOutboxConsumerNames.EventQuestChat;
    ...
    {
        var payload = JsonSerializer.Deserialize<EventQuestChatAnnouncementPayload>(
            message.PayloadJson,
            jsonOptions) ?? throw new InvalidOperationException(
                "Server-wide event chat announcement payload is invalid.");
