...
public sealed class TournamentChatGameEventOutboxConsumer(
    ...
    JsonSerializerOptions jsonOptions) : IGameEventOutboxConsumer
{
    ...
    public string Consumer => GameEventOutboxConsumerNames.TournamentChat;
    ...
    {
        var payload = JsonSerializer.Deserialize<TournamentChatAnnouncementPayload>(
            message.PayloadJson,
            jsonOptions) ?? throw new InvalidOperationException(
                "Tournament chat announcement payload is invalid.");
