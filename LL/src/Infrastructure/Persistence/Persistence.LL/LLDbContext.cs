...
public class LLDbContext(DbContextOptions<LLDbContext> options) : DbContext(options), IDbContext
{
    ...
    public DbSet<Domain.Models.Items.Equipments.Progression.EquipmentUpgradeReceipt> EquipmentUpgradeReceipts => Set<Domain.Models.Items.Equipments.Progression.EquipmentUpgradeReceipt>();
    public DbSet<Domain.Models.Items.Equipments.Progression.EquipmentBlueprintProgress> EquipmentBlueprintProgress => Set<Domain.Models.Items.Equipments.Progression.EquipmentBlueprintProgress>();
