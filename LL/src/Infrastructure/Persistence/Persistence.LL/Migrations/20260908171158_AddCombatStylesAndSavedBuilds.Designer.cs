...
namespace Persistence.LL.Migrations
{
    ...
    [Migration("20260908171158_AddCombatStylesAndSavedBuilds")]
    partial class AddCombatStylesAndSavedBuilds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.CombatStyles.CharacterBuildEquipmentSelection", b =>
                {
                    b.Property<Guid>("CharacterBuildPresetId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("CharacterBuildPresetId", "SlotType");

                    b.ToTable("CharacterBuildEquipmentSelections");
                });

            modelBuilder.Entity("Domain.Models.CombatStyles.CharacterBuildEssenceSelection", b =>
                {
                    b.Property<Guid>("CharacterBuildPresetId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("CharacterBuildPresetId", "SlotIndex");

                    b.ToTable("CharacterBuildEssenceSelections");
                });

            modelBuilder.Entity("Domain.Models.CombatStyles.CharacterBuildPreset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CharacterBuildPresets");
                });
            ...
            modelBuilder.Entity("Domain.Models.CombatStyles.CharacterCombatStyle", b =>
                {
                    ...
                    b.ToTable("CharacterCombatStyles", null, t =>
                        {
                            t.HasCheckConstraint("CK_CharacterCombatStyles_Progression", "\"Level\" BETWEEN 1 AND 10 AND \"CurrentXp\" >= 0 AND (\"Level\" < 10 OR \"CurrentXp\" = 0)");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Models.Essences.EssenceLoadout", b =>
                {
                    ...
                    b.HasIndex("CharacterId", "IsDefault")
                        .IsUnique()
            ...
            modelBuilder.Entity("Domain.Models.Items.Equipments.Progression.EquipmentBlueprintProgress", b =>
                {
                    ...
                    b.HasKey("CharacterId", "FamilyId");

                    b.ToTable("EquipmentBlueprintProgress", (string)null);
                });

            modelBuilder.Entity("Domain.Models.Items.Equipments.Progression.EquipmentUpgradeReceipt", b =>
                {
                    b.Property<Guid>("CharacterId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EquipmentUpgradeReceipts", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.Entities.Characters.Character", b =>
                {
                    ...
                    b.Property<bool>("BastionPracticeCompleted")
                        .HasColumnType("boolean");

                    b.Property<long>("Cinders")
                        .HasColumnType("bigint");

                    b.Property<DateTimeOffset?>("CombatStylesIntroductionCompletedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<bool>("ConduitPracticeCompleted")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.Models.CombatStyles.CharacterBuildEquipmentSelection", b =>
                {
                    b.HasOne("Domain.Models.CombatStyles.CharacterBuildPreset", null)
                        .WithMany("Equipment")
                        .HasForeignKey("CharacterBuildPresetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
