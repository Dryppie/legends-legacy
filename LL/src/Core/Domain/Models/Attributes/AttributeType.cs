...
public enum AttributeType
{
    ...
    Constitution, // 1 = 8 MaxHealth, 10 = 2 HP Regen, 12 = 1 CrowdControlResistance
    Endurance, // 1 = 2 MaxHealth, 4 = 3 PhysicalDefense, 10 = 1 CritDamageReduction
    Willpower, // 10 = 2 MP Regen, 4 = 3 MagicalDefense, 10 = 1 CritDamageReduction,
    Strength, // 10 = 1% CritDamage, 1 = 1 Block
    FightingSpirit, // 10 = 1 HP Regen, 20 = 1 CrowdControlResistance, 4 = 1 Parry
    Dexterity, // 10 = 1% Accuracy, 5 = 0.4% CritChance, 4 = 1 Parry 
    ...
    Perception, // 9 = 0.3% CritChance, 10 = 1% CritDamage, ???, Increase chance of spotting Hidden Rooms in Dungeons and Raids
    Luck, // 3 = 0.2% CritChance, [10 = 0.1% MultiStrike, 10 = 0.1% MultiCast Unsure???????????], Increase chance for Special Encounters in Dungeons and Raids
    // Combat Stats
