...
public interface IWorldTowerService
{
    ...
    Task<TowerOperationResult<TowerRallyDto>> FillDevelopmentTeamAsync(Guid characterId, Guid rallyId, CancellationToken cancellationToken);
    ...
    Task<bool> FinalizePlaybackAsync(Guid attemptId, string leaseOwner, DateTimeOffset now, CancellationToken cancellationToken);
