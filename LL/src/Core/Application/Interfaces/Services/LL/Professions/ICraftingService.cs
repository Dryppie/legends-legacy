...
public interface ICraftingService
{
    ...
    Task<Response<IReadOnlyList<BlueprintLearningOptionDto>>> GetBlueprintLearningOptionsAsync(Guid characterId, Guid blueprintItemInstanceId, CancellationToken cancellationToken);
    ...
    Task<Response<CraftItemsResult>> CraftItemsAsync(Guid characterId, string recipeId, string? formId, string? blueprintId, int targetTier, int quantity, CancellationToken cancellationToken);
}
