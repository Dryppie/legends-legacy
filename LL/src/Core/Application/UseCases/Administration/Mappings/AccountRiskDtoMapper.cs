...
public static class AccountRiskDtoMapper
{
    ...
    public static AccountRiskDetailsDto ToDto(AccountRiskDetails details) => new(
        ...
        details.Signals.Select(x => new AccountRiskSignalDto(x.Type, x.Category, x.Contribution, x.Title, x.Explanation, x.Evidence, x.SupportingTransferIds ?? [], x.FirstObservedAt, x.LastObservedAt, x.SupportingTransferCount, x.SupportingEvidenceComplete, x.CorrelationFamily)).ToList(),
        ...
        details.TotalRetainedTransferCount,
