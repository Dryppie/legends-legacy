...
public record GetCharacterActionQuery(Guid CharacterId) : IQuery<Response<CharacterActionDto?>>;
...
public class GetCharacterActionQueryHandler : IRequestHandler<GetCharacterActionQuery, Response<CharacterActionDto?>>
{
    ...
    {
        var characterAction = await _characterActionService.PeekCharacterActionAsync(request.CharacterId, cancellationToken);
