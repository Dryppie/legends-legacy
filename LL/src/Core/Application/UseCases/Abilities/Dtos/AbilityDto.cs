...
public class AbilityDto : IMapFrom<AbilityDefinition>
{
    ...
    public void Mapping(Profile profile)
    {
        ...
        //// For EffectTags, you might want to combine tags from all damage effects:
        //.ForMember(dto => dto.EffectTags, opt => opt.MapFrom(src => src.Effects
        //    .Where(e => e.EffectType == EffectType.Damage)
        //    .SelectMany(e => (e.Action as DamageAction).EffectTags ?? new List<EffectTag>())
        //    .Distinct()
        //    .ToList()
        //));
    }
