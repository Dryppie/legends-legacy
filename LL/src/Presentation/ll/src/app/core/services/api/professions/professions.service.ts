  ...
  getWoodcuttingNodes(): GatheringNode[] {
    const gatheringNodes: GatheringNode[] = [
      ...
      },
      {
        ...
        levelRequirement: 25,
        description:
          'With vibrant amber leaves and a sturdy trunk, this maple yields a denser wood valued by carpenters for its smooth grain.',
        yield:
          'Resources: Maple Log, Amber Syrup, Sweet Bark Chips, Honeycomb, Glowing Amber.',
      },
      {
        ...
        levelRequirement: 50,
        description:
          'Ashen bark with a faint red glow gives this tree its name. Its timber burns hot and is often used in high-quality forges.',
        yield:
          'Resources: Ash Log, Charcoal Chunk, Fire Beetle Carapace, Scorched Resin, Inferno Bark.',
      },
      {
        ...
        levelRequirement: 75,
        description:
          'Glowing faintly under moonlight, this rare birch produces a pale wood said to resonate with lunar energy.',
        yield: '',
      },
      {
        ...
        description:
          'True to its name, the trunk of this tree is incredibly dense and durable, requiring strength and precision to fell.',
        yield: '',
      },
      {
        ...
        description:
          'Basking in direct sunlight, this golden-toned cedar is prized for its fragrant wood and resistance to decay.',
        yield: '',
      },
      {
        ...
        description:
          'Native to the frozen highlands, this hardy pine is coated in rime. Its resilient wood is ideal for crafting cold-resistant gear.',
        yield: '',
      },
      // {
  ...
  getMiningNodes(): GatheringNode[] {
    const gatheringNodes: GatheringNode[] = [
      ...
      },
      {
        ...
        levelRequirement: 25,
        description:
          'Veins of copper threaded with green-blue bloom-like oxidization. The ore is soft and plentiful, perfect for novice smithing.',
        yield:
          'Resources: Copper Ore, Veinstone Chip, Malachite Shard, Verdant Ore, Living Amber.',
      },
      {
        ...
        levelRequirement: 50,
        description:
          'Thin, jagged deposits of tin that snake through the rock like a spine. Often found in brittle stone that crumbles easily.',
        yield:
          'Resources: Tin Ore, River Pearl, Dull Quartz, Galvanic Dust, Frosted Metal Shard.',
      },
      {
        ...
        levelRequirement: 75,
        description:
          'Dense clusters of dark, solid iron embedded deep in the mountain. Trusted by blacksmiths for its unyielding strength.',
        yield: '',
      },
      {
        ...
        levelRequirement: 100,
        description:
          'Lustrous silver veins that reflect torchlight like moonbeams. This rare ore is highly sought after for enchanted gear.',
        yield: '',
      },
      {
        ...
        levelRequirement: 125,
        description:
          'Radiating with a warm golden glow, this precious vein gleams beneath layers of tough granite. Symbol of wealth and ambition.',
        yield: '',
      },
      {
        ...
        levelRequirement: 150,
        description:
          'Rare, silvery filaments of mithril woven through the deepest rock. Light as air yet stronger than steel—prized by master crafters.',
        yield: '',
      },
      // {
