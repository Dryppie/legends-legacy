...
Implement Bastion and Conduit with separate levels, one defining mechanic, three mutually exclusive refinements, and three upgrades each. Reaper and Duelist are now implemented; see their style guides and implementation status. Shepherd, Gambler and Spellweaver remain design concepts.
