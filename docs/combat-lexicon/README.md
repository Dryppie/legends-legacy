...
| [condition.exposed](conditions/exposed.md)             | Exposed       | Implemented    | +10 percentage points critical chance against target for 10s. |
...
The conditions marked Implemented are supported by the typed ability and combat runtime. Exposed is implemented as a unique ten-second target-side critical-chance bonus. Authored
