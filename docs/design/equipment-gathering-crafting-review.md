...
- **S01 — Gathering behavior and leveling:** removed `CombatGatheringRewardProcessor` and `GatheringProfessionProgression`; retained [LevelingService](../../LL/src/Infrastructure/Service/Services.LL/Levels/LevelingService.cs).
...
- **S05 — Production, unlocks, mastery and queue orchestration:** removed `CraftingService`, `CraftingProgressionService`, and `CraftingRepository`.
...
- **S07 — Composition/material/stat generation:** [EquipmentCraftingDesign](../../LL/src/Core/Domain/Models/Professions/Crafting/V2/EquipmentCraftingDesign.cs), removed `CraftingRequirementResolver`, and [ItemStatRollService](../../LL/src/Infrastructure/Service/Services.LL/Professions/Craftings/ItemStatRollService.cs).
...
- **S10 — Tempering mechanics, eligibility, actions and queue:** retained offline [TemperingMechanicsService](../../LL/src/Infrastructure/Service/Services.LL/Professions/Craftings/TemperingMechanicsService.cs) and [TemperingConstants](../../LL/src/Core/Domain/Models/Professions/Crafting/V2/TemperingConstants.cs); removed `TemperingService`, `TemperingProfileResolver`, and `StartCraftingActionCommand`; general [CharacterActionService](../../LL/src/Infrastructure/Service/Services.LL/CharacterActions/CharacterActionService.cs) and [CharacterActionRepository](../../LL/src/Infrastructure/Persistence/Persistence.LL/Repositories/CharacterActions/CharacterActionRepository.cs) remain.
...
- **S19 — Tempering checks and retained flags:** [TemperingMechanicsServiceTests](../../LL/tests/EssenceSystem.Tests/TemperingMechanicsServiceTests.cs), removed crafting-achievement content, and [EquipmentSnapshot](../../LL/src/Core/Domain/Models/Snapshots/EquipmentSnapshot.cs).
...
- **S21 — Tutorial dependencies:** the original `first-weapon.v1.json` and `tools-of-the-trade.v1.json` definitions were removed.
...
- **S24 — Player-facing production/investment screens:** the regular crafting and tempering components were removed.

[S01]: equipment-post-alpha-cleanup.md#removed-after-alpha
...
[S05]: equipment-post-alpha-cleanup.md#removed-after-alpha
...
[S21]: equipment-post-alpha-cleanup.md#removed-after-alpha
...
[S24]: equipment-post-alpha-cleanup.md#removed-after-alpha
