...
The numerical inputs and generated reports in this directory are balance artifacts. Any Scrap, Blueprint, or Forge projections in older generated output are historical and are not current gameplay requirements.

See [equipment contract](equipment-specification.md), [implementation status](equipment-implementation-status.md), and [Forge removal](equipment-forge-removal.md).
