...
| Guardian mechanics        | **Partial** | Floors 1–4 have fully authored active/passive kits, including Morrowmaw's Broodling lifecycle on Floor 3; remaining Guardians still rely partly on existing creature mechanics, scaling, tags, and scouting descriptions. Monster artwork is intentionally excluded.                                                                                                     |
...
Guardian identity and abilities are data-driven, and combat uses existing creature definitions with configurable strength. Floors 1–4 have authored kits; Floor 3's Morrowmaw can create permanent owned Broodlings with 10% of Morrowmaw's Max Health and a Poison(10) active, consume the weakest matching Broodling for Max-Health healing, and synchronize Damage Reduction and Attack Speed with the living brood count. Tags and scouting reveals communicate intended mechanics. Floors 5–10 do not yet have fully authored kits, and the combat layer does not interpret a Tower-specific phase/mechanic definition or floor-authored ability sequence.
